...
SGNsGrab.NsGrab.prototype = {
    ...
    grabPage : function() {
        ...
        return this.grab(frameDim.getWindow(), box);
    },
    
	grabFullPageContext : function (doc) {
		var rv = this.grabPage();
		return rv[1];
	},
    ...
    grabSelection : function(grabBox) {
        ...
        return this.grab(SGNsUtils.getCurrentBrowserWindow(), box);
    },
...
//		this.saveToFile(dataUrl, format);
    ...
    prepareCanvas : function(width, height) {
        ...
        var grabCanvas = document.getElementById("fbi2e_buffer_canvas");
